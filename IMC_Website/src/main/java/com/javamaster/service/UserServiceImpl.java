...
public class UserServiceImpl implements UsersService{
    ...
    @Override
    public void register(String name, Integer age, String sex, String height, String email, String password){
    ...
    @Override
    public void record(String date,  String altura, String peso, String imc){
