    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (uri.equals("/main-page")) {
            if (request.getSession().getAttribute("user") == null) {
                ...
                UserServiceImpl.getInstance().record(date, altura, peso, imc);
                request.getRequestDispatcher("/WEB-INF/view/main-page.jsp").forward(request, response);
            }
        } else if (uri.equals("/resultado")) {
            // Display a success message or do any other necessary processing for this URI
            request.getRequestDispatcher("/WEB-INF/view/resultado.jsp").forward(request, response);
